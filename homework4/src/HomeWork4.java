...
public class HomeWork4 {
    ...
    public static void ex3() {
        ...
        Bird bird = new Bird();
        SoundMaker[] soundMaker = new SoundMaker[]{human, builder, driver, bird};

        System.out.println(human.makeSound());
        System.out.println(builder.makeSound());
        System.out.println(driver.makeSound());
    ...
    public static void ex4() {
        ...
        OneGramChat oneGramChat = new OneGramChat(new User[100]);
